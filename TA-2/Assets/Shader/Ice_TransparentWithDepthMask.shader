...
Shader "Vuforia/Ice_TransparentWithDepthMask"
{
    Properties
    {
        ...
        _Reflections ("Reflection SphereMap", 2D) = "White" {TexGen SphereMap}
    ...
    Pass
        {
            ...
            {
                v2f o;
                float4 scaled_vertex = float4(v.vertex);
                scaled_vertex.x *= 0.7;
                scaled_vertex.y *= 0.7;
                scaled_vertex.z *= 0.7;
                o.pos = mul (UNITY_MATRIX_MVP, scaled_vertex);
                return o;
            }
