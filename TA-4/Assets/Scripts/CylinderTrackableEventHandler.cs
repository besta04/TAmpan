                                            ...
                                            ITrackableEventHandler
{
    ...
    private void OnTrackingFound()
    {
        ...
        if (!m_TrackableDetectedForFirstTime)
        {
            if (this.CylinderTrackableFoundFirstTime != null)
            {
                ...
                debugLog.InsertLog("First Time Trackable Found at [" + Time.time + "]");
            }
            m_TrackableDetectedForFirstTime = true;
        }
        cylinderDetected = true;
        Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + " found");
        debugLog.InsertLog("Trackable " + mTrackableBehaviour.TrackableName + " found");
    }
    ...
    private void OnTrackingLost()
    {
        ...
        debugLog.InsertLog("Trackable " + mTrackableBehaviour.TrackableName + " lost");
    }
